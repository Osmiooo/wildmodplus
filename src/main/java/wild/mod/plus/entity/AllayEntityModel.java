...
public class AllayEntityModel extends EntityModel<AllayEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData1.addChild("left_wing", ModelPartBuilder.create().uv(16,16).cuboid(0.0F, -1.0F, 0.0F, 12.0F, 7.0F, 0.0F), ModelTransform.pivot(2.0F,1.0F,2.0F));
		modelPartData1.addChild("right_wing", ModelPartBuilder.create().uv(16,16).cuboid(-12.0F, -1.0F, 0.0F, 12.0F, 7.0F, 0.0F), ModelTransform.pivot(-2.0F,1.0F,2.0F));
